# SCARS — sample-project hard-won failure memory

> Minimal example. Read **before** fixing a bug. Real projects accrete anchors
> over time. See [Atlas SPEC](https://github.com/Abbasi-Alain/atlas/blob/main/docs/SPEC.md).
